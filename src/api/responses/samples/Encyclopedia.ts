    ...
    data: {
        ...
        ship_type_images: {
            Destroyer: {
                ...
                image: "http://glossary-na-static.gcdn.co/icons/wows/current/vehicle/types/Destroyer/normal.png",
                image_elite: "http://glossary-na-static.gcdn.co/icons/wows/current/vehicle/types/Destroyer/elite.png"
            },
            AirCarrier: {
                image_premium:
                    "http://glossary-na-static.gcdn.co/icons/wows/current/vehicle/types/AirCarrier/premium.png",
                image: "http://glossary-na-static.gcdn.co/icons/wows/current/vehicle/types/AirCarrier/normal.png",
                image_elite: "http://glossary-na-static.gcdn.co/icons/wows/current/vehicle/types/AirCarrier/elite.png"
            },
            Battleship: {
                image_premium:
                    "http://glossary-na-static.gcdn.co/icons/wows/current/vehicle/types/Battleship/premium.png",
                image: "http://glossary-na-static.gcdn.co/icons/wows/current/vehicle/types/Battleship/normal.png",
                image_elite: "http://glossary-na-static.gcdn.co/icons/wows/current/vehicle/types/Battleship/elite.png"
            },
            Cruiser: {
                image_premium: "http://glossary-na-static.gcdn.co/icons/wows/current/vehicle/types/Cruiser/premium.png",
                image: "http://glossary-na-static.gcdn.co/icons/wows/current/vehicle/types/Cruiser/normal.png",
                image_elite: "http://glossary-na-static.gcdn.co/icons/wows/current/vehicle/types/Cruiser/elite.png"
            }
        },
        ship_nations: {
